        ...
        <div class="row mt-12 pb-12">
            <div class="lg:col-6 col-12 !pt-0">
                <form action="{{ route('check-in.step-one.next') }}" method="POST">
                    ...
                    <div class="row mt-4">
                        <div class="lg:col-6 md:col-6 col-12 relative">
                            <label class="block tracking-wide text-black text-sm font-medium mb-2 required" for="entry_gate_number">
                                {{ __('visitor.entry_gate_number') }}
                            </label>
                            <select name="entry_gate_number" id="entry_gate_number"
                                class="appearance-none block w-full text-primary border border-[#97A3C0] rounded-[12px] py-3 px-4 mb-1 leading-tight focus:outline-none focus:bg-white @error('entry_gate_number') is-invalid @enderror">
                                <option value="">{{ __('visitor.select_entry_gate') }}</option>
                                @for($g = 1; $g <= 10; $g++)
                                    <option value="Gate {{ $g }}" {{ old('entry_gate_number', $visitingDetails['entry_gate_number'] ?? '') == 'Gate '.$g ? 'selected' : '' }}>
                                        Gate {{ $g }}
                                    </option>
                                @endfor
                            </select>
...
<div class="row mt-4">
    <div class="lg:col-12 md:col-12 col-12">
        <h5 class="mb-3 text-primary font-medium">Vehicle Information (Optional)</h5>
    </div>

    <!-- Vehicle Number -->
    <div class="lg:col-4 md:col-6 col-12 mb-4">
        <label class="block tracking-wide text-black text-sm font-medium mb-2" for="vehicle_number">
            Vehicle Number <span class="text-muted">(Optional)</span>
        </label>
        <input type="text" 
               name="vehicle_number" 
               id="vehicle_number"
               class="appearance-none block w-full text-primary border border-[#97A3C0] rounded-[12px] py-3 px-4 mb-1 leading-tight focus:outline-none focus:bg-white @error('vehicle_number') is-invalid @enderror"
    ...
    <!-- Vehicle Compliance -->
    <div class="lg:col-4 md:col-6 col-12 mb-4 relative">
        <label class="block tracking-wide text-black text-sm font-medium mb-2" for="vehicle_compliance">
            Vehicle Compliance
        </label>
        <select name="vehicle_compliance" id="vehicle_compliance"
            class="appearance-none block w-full text-primary border border-[#97A3C0] rounded-[12px] py-3 px-4 mb-1 leading-tight focus:outline-none focus:bg-white @error('vehicle_compliance') is-invalid @enderror">
    ...
    <!-- Vehicle Remarks -->
    <div class="lg:col-4 md:col-12 col-12 mb-4">
        <label class="block tracking-wide text-black text-sm font-medium mb-2" for="vehicle_remarks">
            Vehicle Remarks
        </label>
        <textarea name="vehicle_remarks" id="vehicle_remarks"
            class="appearance-none block w-full text-primary border border-[#97A3C0] rounded-[12px] py-3 px-4 leading-tight focus:outline-none focus:bg-white @error('vehicle_remarks') is-invalid @enderror"
            rows="2"
            placeholder="Any remarks about vehicle...">{{ old('vehicle_remarks', $visitingDetails['vehicle_remarks'] ?? '') }}</textarea>
